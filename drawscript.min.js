...
// TODO Use shared modules between client/server for the following
var Entity = class
{
...
var startWebsocketSession = function(username, myPicUrl){
	...
	document.getElementById('send-chat-msg').addEventListener('click', function(){
    ...
    liEle.innerHTML = msg;
		document.querySelector('#messages').appendChild(liEle);
	});
	socket.on('connect', function(){
    const liEle = document.createElement('li');
    liEle.innerHTML = "Connected successfully!";
		document.querySelector('#messages').appendChild(liEle);
	});
